...
public class parentpage 
{
	...
	public parentpage() 
	{
		try
		{
			...
			prop=new Properties();
			FileInputStream IP = new FileInputStream("/Users/abhi28577/eclipse-workspace/ComputerDbase/src/main/java/org/computerdb/config/config.properties");
			prop.load(IP);
		}
